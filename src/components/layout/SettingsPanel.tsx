...
const ConfirmDialog: React.FC<ConfirmDialogProps> = ({ title, message, confirmLabel = '确认', danger, onConfirm, onCancel }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onPointerDown={onCancel}>
    <div
...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ open, onClose, initialSection = 'appearance' }) => {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/50" onPointerDown={onClose}>
      <div
